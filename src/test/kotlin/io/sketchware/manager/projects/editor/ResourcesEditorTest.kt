...
import `fun`.kotlingang.sketchware.editors.project.ResourcesEditor
...
internal class ResourcesEditorTest {

    private val resourcesManager = ResourcesEditor(resourcesValue, File(""))
