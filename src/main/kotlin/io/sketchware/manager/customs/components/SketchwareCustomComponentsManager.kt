...
class SketchwareCustomComponentsManager(
    ...
    companion object {
        suspend operator fun invoke(file: File) =
            SketchwareCustomComponentsManager(file.read().byteArrayToString(), file)
    }

    private val componentProperty = lazyInit { value.serialize<List<CustomComponent>>() }
