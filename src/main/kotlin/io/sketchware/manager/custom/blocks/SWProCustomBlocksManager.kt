package io.sketchware.manager.custom.blocks

import io.sketchware.`interface`.Editor
import io.sketchware.`interface`.FileExportable
import io.sketchware.`interface`.FileImportable
import io.sketchware.`interface`.listener.ActionFinishListener
import io.sketchware.model.custom.CustomBlock
import io.sketchware.model.custom.CustomBlockGroup
import io.sketchware.model.custom.Palette
...
class SWProCustomBlocksManager(
